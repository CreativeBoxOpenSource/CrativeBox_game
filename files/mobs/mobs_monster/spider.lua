...
mobs:register_egg("mobs_monster:spider", mobs_monster.S"Spider", "mobs_monster_spider.png")
mobs:register_egg("mobs_monster:small_spider", mobs_monster.S"Small Spider", "mobs_monster_small_spider.png")
